...
const ConversionListView: React.FC = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                const data: any = await conversionService.getFilteredConversions(page, size, debouncedSearchTerm, startDate, endDate)
    ...
    return (
        <Page className={classes.root} title="Конвертация">
...
export default ConversionListView