                        ...
                        >
                            ...
                            <Grid item>
                                ...
                                >
                                    ...
                                    <br/>
                                    Дата оплаты: {isPaidApplication(incomeArticle) ? incomeArticle.updatedDate : "-"}
                                    <br/>
                                    Статус: {mapOfStatusApplication.get(incomeArticle.status!)}
                                    <br/>
                                    Коментарии: {incomeArticle.description}
                                </Typography>
                            </Grid>
                        </Grid>
                    </Box>
