...
import OutcomeTransferWarehousePDF from "./OutcomeTransferWarehousePDF";
...
const Header: React.FC<{outcomeTransferWarehouse: OutcomeTransferWarehouseApplication}> = ({outcomeTransferWarehouse}) => {
            ...
            <Grid item>
                ...
                >
                    ...
                    <Typography
                        ...
                        color="textPrimary"
                    >
                        {`Заявка № ${outcomeTransferWarehouse.id}`}
                    </Typography>
                </Breadcrumbs>
                <Typography
                    variant="h3"
                    ...
                    >
                        ...
                        <Box flexGrow={1}>
                            <PDFViewer
                                ...
                                style={{ border: 'none' }}
                            >
                                <OutcomeTransferWarehousePDF outcomeTransferWarehouse={outcomeTransferWarehouse} />
                            </PDFViewer>
                        </Box>
                    </Box>
                </Dialog>
